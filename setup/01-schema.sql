...
--
-- Safe to run once on an empty database. It creates every table the app needs.
-- Afterwards, open the deployed site and click "Start free" to create your
-- account, or run 02-demo-data.sql first if you want the sample company.
